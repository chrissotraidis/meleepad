...
apply_patch_once "$MG/vendor/dolphin" "$ROOT/patches/moderngekko-dolphin/0057-frame-interval-summary.patch"
apply_patch_once "$MG/vendor/dolphin" "$ROOT/patches/moderngekko-dolphin/0058-gameplay-scene-snapshot.patch"
