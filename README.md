...
| **Game input** | Development build 9: verified USA v1.02 recommended, v1.00 retained; published Preview 3: v1.00 only |
...
Development build 9 supports USA v1.02 as the preferred revision while
...
locations. Development build 9 supports verified USA v1.02 (disc revision 2),
...
MeleePad supports v1.02 and v1.00 in development build 9 and uses its own
...
2. Confirm that both players use the same build, the exact supported `GALE01`
   ...
   build 9 for its new execution policy; build 9 rejects older peers. For the
