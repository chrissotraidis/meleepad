#!/usr/bin/env python3
"""Compile and exercise the vendored ENet outgoing dispatch implementation locally."""
...
def main() -> None:
    ...
    fixture = root / "tests/SlippiENetDispatchTests.c"
    sources = [enet / f"{name}.c" for name in
               ("callbacks", "compress", "host", "list", "packet", "peer", "protocol", "unix")]
    ...
    with tempfile.TemporaryDirectory(prefix="meleepad-enet-dispatch-") as temporary:
        binary = Path(temporary) / "enet-dispatch-test"
