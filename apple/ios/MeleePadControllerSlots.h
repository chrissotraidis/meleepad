...
struct MeleePadControllerSlotChange {
  uintptr_t instance = 0;
  std::size_t slot = 0;
};

struct MeleePadControllerReconcileResult {
  std::vector<MeleePadControllerSlotChange> removed;
  std::vector<MeleePadControllerSlotChange> assigned;
};
...
class MeleePadControllerSlots {
 public:
  static constexpr std::size_t kMaxPlayers = 4;

  MeleePadControllerReconcileResult Reconcile(
    ...
    MeleePadControllerReconcileResult result;
