...
| 7 | Audio continuity | Fail / materially improved and attributed | Combined exact-source host and game-module PGO now sustains long 59.8-60.0 FPS combat stretches, but cold shader/resource creation still produces 32-54 FPS windows and DMA underruns. The warmed repeat is much better but retains a 36.5 presentation-FPS transition, a 59.2 FPS heavy interval, and isolated underruns. Row 7 is not continuous yet. See the combined-PGO artifact. |
...
1. Split row 7's remaining causes: first test a measured Metal pipeline/resource
   persistence or prewarm mechanism against the cold-process collapse, then
   address the warmed residual generated-dispatch/static-core ceiling. Combined
   host+module PGO is the new comparison floor. Exact-PGO O3 is structurally
   rejected and must not be replayed.
