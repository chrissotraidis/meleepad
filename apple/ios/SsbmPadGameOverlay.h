...
@class SsbmPadGameOverlay;

@protocol SsbmPadGameOverlayDelegate <NSObject>
...
@interface SsbmPadGameOverlay : UIView

@property(nonatomic, weak, nullable) id<SsbmPadGameOverlayDelegate> delegate;
