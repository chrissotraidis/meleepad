...
std::string MeleePadEncodePipeCommands(const MeleePadInputState &input,
    ...
    struct {
        ...
        {MeleePadButtonA, "A"},    {MeleePadButtonB, "B"},
        {MeleePadButtonX, "X"},    {MeleePadButtonY, "Y"},
        {MeleePadButtonZ, "Z"},    {MeleePadButtonStart, "START"},
        {MeleePadButtonL, "L"},    {MeleePadButtonR, "R"},
        {MeleePadButtonDpadUp, "D_UP"},
        {MeleePadButtonDpadDown, "D_DOWN"},
        {MeleePadButtonDpadLeft, "D_LEFT"},
        {MeleePadButtonDpadRight, "D_RIGHT"},
    };
